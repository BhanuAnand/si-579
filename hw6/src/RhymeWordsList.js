...
function RhymeWordsList () {
    ...
    const [outDescEl, setOutDescEl] = useState('(fill in the description)');
    ...
    return (<div className="container"> 
        ...
        <div className="row">
            <div className="col">Saved words: <span>{savedOutput ? savedOutput : '(put saved wored here)'}</span></div>
        </div>
        <div className="row">
        ...
        <div className="output row">
            <output className="col">
                { state ? dataResponse : '(put output here)'}
            </output>
        </div>
    </div>)
